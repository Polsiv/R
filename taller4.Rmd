...
desv_est_diferencias = sqrt(s.a^2 + s.d^2)
...
H0: La reducción promedio real/poblacional del grupo A = La reducción promedio real/poblacional del grupo B  
(H0: Mu.A = Mu.B → Mu.A - Mu.B = 0)

Ha: La reducción promedio real/poblacional del grupo A != La reducción promedio real/poblacional del grupo B  
...
H0 Varianza real/poblacional de la reducción del grupo A = Varianza real/poblacional de la reducción del grupo B  
(H0: Var.A = Var.B)

Ha:Varianza real/poblacional de la reducción del grupo A != Varianza real/poblacional de la reducción del grupo B  
(Ha: Var.A != Var.B)
