...
# Create a histogram of the 'Camisetas' column
hist(as.integer(camisetas[,2]),
     main="Frecuencia de Ventas en Camisetas",
     xlab = "Ventas",
     ylab = "Frecuencia",
     ylim = c(0,14),
     xlim = c(0, 2200),
...
Una vez definidos los datos, se grafica un histograma de la venta de las camisas con respecto a su sucursal; este histograma representa lo siguiente:

1) Hubieron 13 sucursales que vendieron menos de 250 camisetas
2) Hubieron 4 sucursales que vendieron menos de 500 camisetas
3) Hubo 1 sucursal que vendio mas de...

Otro dato a observar es que 2 sucursales vendieron al rededor de 2000 unidades, las cuales son atipicas con respecto del resto, que tuvieron dificultad vendiendo mas de 1000 unidades
